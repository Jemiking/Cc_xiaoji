...
import com.ccxiaoji.feature.ledger.domain.model.RecurringTransaction
...
class RecurringTransactionRepository @Inject constructor(
    ...
    fun getEnabledRecurringTransactions(userId: String): Flow<List<RecurringTransaction>> {
    ...
    suspend fun getRecurringTransactionById(id: String): RecurringTransaction? {
        return recurringTransactionDao.getRecurringTransactionById(id)?.toDomainModel()
    }
