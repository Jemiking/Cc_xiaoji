...
class RecurringTransactionRepository @Inject constructor(
    ...
    fun getAllRecurringTransactions(): Flow<List<RecurringTransactionEntity>> {
        return recurringTransactionDao.getAllRecurringTransactions(userApi.getCurrentUserId())
    }
    
    fun getEnabledRecurringTransactions(): Flow<List<RecurringTransactionEntity>> {
        return recurringTransactionDao.getEnabledRecurringTransactions(userApi.getCurrentUserId())
    }
