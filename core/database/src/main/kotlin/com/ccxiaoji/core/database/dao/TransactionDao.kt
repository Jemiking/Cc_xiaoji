...
interface TransactionDao {
    ...
    @Query("SELECT COUNT(*) FROM transactions WHERE userId = :userId AND createdAt >= :startTime AND createdAt < :endTime AND isDeleted = 0")
    suspend fun getTransactionCountByDateRange(userId: String, startTime: Long, endTime: Long): Int
